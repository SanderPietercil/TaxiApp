			...
			<div class="box-body">
				<div class="row clearfix">
					...
					<div class="col-md-6">
						...
						<div class="form-group">
							<input type="text" name="register_date" value="<?php echo ($this->input->post('register_date') ? $this->input->post('register_date') : $user['register_date']); ?>" class="form-control" id="register_date" />
						</div>
					</div>
				</div>
			</div>
